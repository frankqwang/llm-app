...
class VlogCopilotUiTextTest {
  ...
  fun operationClassifierSeparatesRefreshFromMaking() {
    ...
    assertEquals(VlogCopilotOperation.RefreshingStories, refresh)
    assertEquals(VlogCopilotOperation.MakingVideos, making)
  }
}
