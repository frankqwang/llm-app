 ...
 *
 * VlogCopilot — on-device port of pc-pilot. The app turns a photo album segment
...
class VlogCopilotTask @Inject constructor() : CustomTask {
  ...
  override fun MainScreen(data: Any) {
    ...
    // VlogCopilotRootScreen with the VlogCopilot tabs. This MainScreen exists
  ...
  companion object {
    const val TASK_ID = "vlog_copilot"
  }
}
