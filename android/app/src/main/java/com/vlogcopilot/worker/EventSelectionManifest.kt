 ...
 *
 * Durable event-selection explanation shown in the VlogCopilot "事件选择" tab.
 */
...
data class EventSelectionManifest(
  ...
  val excludedEventIds: List<String> = emptyList(),
  val forceRegenerateEventIds: List<String> = emptyList(),
  val onlySelectedEventIds: List<String> = emptyList(),
