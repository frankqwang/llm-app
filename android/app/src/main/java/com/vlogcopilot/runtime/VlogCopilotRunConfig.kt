 ...
 *
 * User-facing generation controls for VlogCopilot. Kept in SharedPreferences so
...
data class VlogCopilotRunConfig(
  ...
  companion object {
    private const val PREFS = "vlog_copilot_run_config"
    ...
    fun load(context: Context): VlogCopilotRunConfig {
      val p = prefs(context)
      return VlogCopilotRunConfig(
